...
//     return <div>Location data not available</div>; // Handle the case where coordinates are missing
//   }
...
//   return (
//     <MapContainer center={[latitude, longitude]} zoom={13} style={{ width: '100%', height: '400px' }}>
//       <TileLayer
